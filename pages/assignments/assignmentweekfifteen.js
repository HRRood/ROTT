  ...
  return (
    <div>
      ...
      <Row>
        <Column width={100} smWidth={100} lgWidth={100}>
          <p>
            Voor school ben je druk bezig met een groot project. Je zit met je groep in de afrondende fase, en maandag over een week is de deadline. Aankomende
            week heb je nog de tijd om alles tot een mooi resultaat te brengen. Naar verwachting zal dit je nog 20 uur aan huiswerk kosten.
          </p>
          <p>
          ...
          <ol>
            ...
            <li>
              Vul vervolgens het schema aan met de andere activiteiten die je deze week nog graag wilt doen. Ga je uit? Wil je nog sporten? Of gewoon een paar
              uur niks doen?
            </li>
            <li>
